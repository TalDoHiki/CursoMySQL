...
INSERT INTO `gafanhoto_assiste_curso` VALUES (1,'2014-03-01',1,2),(2,'2014-03-01',3,6),(3,'2014-03-01',22,12),(4,'2014-03-01',1,19);
...
CREATE TABLE `gafanhotos` (
  ...
  CONSTRAINT `gafanhotos_ibfk_5` FOREIGN KEY (`cursopreferido`) REFERENCES `cursos` (`idcurso`),
  CONSTRAINT `gafanhotos_ibfk_6` FOREIGN KEY (`cursopreferido`) REFERENCES `cursos` (`idcurso`),
  CONSTRAINT `gafanhotos_ibfk_7` FOREIGN KEY (`cursopreferido`) REFERENCES `cursos` (`idcurso`)
...
-- Dump completed on 2023-02-16 15:40:58
